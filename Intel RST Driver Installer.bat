...
if exist "%Windows%\sources" if not exist "%Windows%\x86\sources" if not exist "%Windows%\x64\sources" goto "CheckExist"
if exist "%Windows%\x86\sources" if exist "%Windows%\x64\sources" if not exist "%Windows%\sources" goto "CheckExist"
